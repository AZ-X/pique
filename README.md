...
[Download the latest release with golang 1.15 for AMD64 on Windows or Linux](https://github.com/AZ-X/pique/releases/tag/v1.2.16)

[Download the latest release with golang 1.16 for AMD64 on Windows or Linux](https://github.com/AZ-X/pique/releases/tag/v1.2.17)
...
1. If you are incapable of tuning `the compiler`, change the source code(lots of linknames) by yourself and compile it.
1. Mod your own compiler, then just compile the source code without modification.

There won't be any binary release targeting 1.18 because the risk of CoT (compiler of things) is extraordinary thus the author is quite sluggard to alter the form of linknames.
